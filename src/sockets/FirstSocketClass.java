...
//                    This is the initialization Steps [ 4 step common ]
                        ...
                        PrintStream toClientPrinter = new PrintStream(outgoingDataToClient);
                ) {
            while (true) {
                //    [1- Input ]
                String clientMessage = bufferedReader.readLine();
                String serverMessage="Hello This is the serve ";
//              [1- processing ]
                if(clientMessage.toLowerCase().trim().equals("bye")){
                    break;
                }

//              [1- output ]
                System.out.println(clientMessage);
                toClientPrinter.println(clientMessage);
